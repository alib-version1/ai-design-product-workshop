...
Use these prompts with **AWS Kiro** or **GitHub Copilot in VS Code** during Sprint 2 to build your prototype. Copy the prompt, replace the `[bracketed sections]` with your own content, and paste into the chat.
